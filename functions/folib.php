...
function datetime()
{
    ...
    $month = date("n");
    $year = date("Y");
    $monthz = array(1=>'ledna', 'února', 'bøezna', 'dubna', 'kvìtna', 'èervna', 'èervence', 'srpna', 'záøí', 'øíjna', 'listopadu', 'prosince');
    //$dni = Array('', 'nedìle','pondìlí','úterý','støeda','ètvrtek','pátek','sobota');
...
function menu_kdo()
{
    ...
    if ($GLOBALS['who'] == 'student') {
        $strHTML .= '
                    ...
                    <li><a href="' . odkaz($GLOBALS['napln'], 'ucitel') . '" title="Sekce stránek pro uèitele">Uèitel</a></li>
        ...
        $strHTML .= '
                    ...
                    <li><a href="' . odkaz($GLOBALS['napln'], 'ucitel') . '" title="Sekce stránek pro uèitele" class="selected">Uèitel</a></li>
                    <li><a href="' . odkaz($GLOBALS['napln'], 'organizator') . '" title="Sekce stránek pro organzátory">Organizátor</a></li>';
...
function pocitadlo()
{
    ...
    //vytáhnu si všechny IP adresy online návštìvníkù
    $GLOBALS['mysql']->query('
