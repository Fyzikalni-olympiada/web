<?php
echo '
<h2>Výsledky karlovarských kol '. AKTUALNI_ROCNIK . '.&nbsp;roèníku Fyzikální olympiády</h2>

<p>
Zde budeme bìhem školního roku '. AKTUALNI_ROK . ' uveøejòovat výsledkové listiny všech soutìžních kol Fyzikální olympiády konaných v&nbsp;karlovarském kraji.
</p>
...
echo '
<p>
Starší výsledkové listiny najdete v&nbsp;<a href="' . odkaz('kvary/content/archiv.php') . '" title="Archiv výsledkù">archivu</a>.
</p>
</div> <!-- archiv_vysledky -->';
