...
if ($kdo == "student")
	echo '
	<p>Toto diskusní fórum je urèeno pro studenty. Mùžete se zde vyjadøovat ohlednì prùbìhu olympiády, kvality úloh, pøípadnì mít nìjaké jiné pøipomínky èi dotazy.';
if ($kdo == "ucitel")
	echo '
	<p>Toto diskusní fórum je urèeno pro uèitele. Mùžete se zde vyjadøovat ohlednì prùbìhu olympiády, kvality úloh, pøípadnì mít nìjaké jiné pøipomínky èi dotazy.';
if ($kdo == "organizator")
	echo '
	<p>Toto diskusní fórum je urèeno pro organizátory. Mùžete se zde vyjadøovat ohlednì prùbìhu olympiády, kvality úloh, pøípadnì mít nìjaké jiné pøipomínky èi dotazy.';
...
if (!empty($chyba) || isset($_POST['ok'])) { 
	...
	if (isset($GLOBALS['get']['forum_id']) && (isset($GLOBALS['get']['upravit']) || isset($GLOBALS['get']['reagovat']))) {
		...
		if ($row = mysql_fetch_array($result)) {
			...
			/** Úprava pøíspìvku (musí být nalogován nebo administrátor) */
...
echo '
<div id="respond">
    <div class="legend" id="comment-form-title">Vložit pøíspìvek</div>
